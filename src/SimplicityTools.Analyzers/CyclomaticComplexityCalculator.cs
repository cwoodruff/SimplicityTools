...
/// <c>SimplicityTools.Metrics.CyclomaticComplexityAnalyzer</c>, which duplicates this logic
/// because analyzer assemblies cannot reference the metrics assembly.
///
/// Rules summary:
...
internal static class CyclomaticComplexityCalculator
{
    ...
    /// functions are their own units (measured separately), so they contribute nothing here.
    /// </summary>
